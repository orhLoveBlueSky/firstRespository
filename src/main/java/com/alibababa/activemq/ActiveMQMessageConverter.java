...
public class ActiveMQMessageConverter implements MessageConverter {
     ...
     * @throws JMSException
     * (non-Javadoc)
     * @see org.springframework.jms.support.converter.MessageConverter#toMessage(Object, Session)
     */
     ...
     * @throws JMSException
     * (non-Javadoc)
     * @see org.springframework.jms.support.converter.MessageConverter#fromMessage(Message)
     */
